...
function translateDE(){
  ...
  var xhr = new XMLHttpRequest();
    xhr.open('GET', './destinations/DE/romeDE.json', true);
    xhr.onload = function() {
        if (xhr.status === 200) {
...
function translateKR(){
  var xhr = new XMLHttpRequest();
    xhr.open('GET', './destinations/KR/romeKR.json', true);
    xhr.onload = function() {
        if (xhr.status === 200) {
        var jsonData = JSON.parse(xhr.responseText);
...
function translateZH(){
    var xhr = new XMLHttpRequest();
      xhr.open('GET', './destinations/ZH/romeZH.json', true);
      xhr.onload = function() {
          if (xhr.status === 200) {
          var jsonData = JSON.parse(xhr.responseText);
...
function translateFR(){
  var xhr = new XMLHttpRequest();
    xhr.open('GET', './destinations/FR/romeFR.json', true);
    xhr.onload = function() {
        if (xhr.status === 200) {
        var jsonData = JSON.parse(xhr.responseText);
...
function translateEN(){
  var xhr = new XMLHttpRequest();
    xhr.open('GET', './destinations/rome.json', true);
    xhr.onload = function() {
        if (xhr.status === 200) {
        var jsonData = JSON.parse(xhr.responseText);
...
function translateVN(){
    var xhr = new XMLHttpRequest();
      xhr.open('GET', './destinations/VN/romeVN.json', true);
      xhr.onload = function() {
          if (xhr.status === 200) {
          var jsonData = JSON.parse(xhr.responseText);
...
function translateJP(){
    var xhr = new XMLHttpRequest();
      xhr.open('GET', './destinations/JP/romeJP.json', true);
      xhr.onload = function() {
          if (xhr.status === 200) {
          var jsonData = JSON.parse(xhr.responseText);
